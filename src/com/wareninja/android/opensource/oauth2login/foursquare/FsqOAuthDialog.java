...
public class FsqOAuthDialog extends Dialog {
	...
	public static final String SIGNIN_URI = AppContext.FSQ_APP_REDIRECT_SIGNIN;
    public static final String OAUTHCALLBACK_URI = AppContext.FSQ_APP_CALLBACK_OAUTHCALLBACK;
