...
public class FsqOAuthDialog extends Dialog {
	...
	public static final String SIGNIN_URI = MCONSTANTS.FSQ_APP_REDIRECT_SIGNIN;
    public static final String OAUTHCALLBACK_URI = MCONSTANTS.FSQ_APP_CALLBACK_OAUTHCALLBACK;
    ...
    public FsqOAuthDialog(Context context, String url, GenericDialogListener listener) {
        super(context);
        mUrl = url;
        mListener = listener;
    }
