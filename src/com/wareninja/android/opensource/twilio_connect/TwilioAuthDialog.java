...
package com.wareninja.android.opensource.twilio_connect;
...
public class TwilioAuthDialog extends Dialog {

	private static final String TAG = "TwilioAuthDialog";
	
	/* Strings used in the Connect flow */
    ...
    public TwilioAuthDialog(Context context, String url, GenericDialogListener listener) {
        super(context);
        mUrl = url;
        mListener = listener;
    }
    ...
    private void setUpTitle() {
        ...
        Drawable icon = getContext().getResources().getDrawable(
                R.drawable.img_icon_twiliologin_header_small);
        mTitle = new TextView(getContext());
        mTitle.setText("TWILIO Connect");
    ...
    private void setUpWebView() {
        ...
        mWebView.setWebViewClient(new TwilioAuthDialog.OAuthWebViewClient());
    ...
    private class OAuthWebViewClient extends WebViewClient {
        ...
        public void onReceivedError(WebView view, int errorCode,
            ...
            /*// should also pass error back to listener!
             * mListener.onError( 
                    new DialogError(description, errorCode, failingUrl));*/
            TwilioAuthDialog.this.dismiss();
        }
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            if (url.startsWith(OAUTHCALLBACK_URI)) {
            	if(AppContext.DEBUG)Log.d(TAG, "url1->"+url);
            	// looks like fb started to add # instead of ?
            	if (url.startsWith(OAUTHCALLBACK_URI+"/#")) {
            		url = "http://dummy_uri" + "?"+url.substring(url.indexOf("#")+1);
            	}
            	else {
            		url = "http://dummy_uri" +url.substring(OAUTHCALLBACK_URI.length());
            	}
            	if(AppContext.DEBUG)Log.d(TAG, "url2->"+url);            	
