...
package com.wareninja.android.opensource.oauth2login.instagram;
...
public class InstagramOAuthDialog extends Dialog {
    ...
    public static final String OAUTHCALLBACK_URI = AppContext.INSTAGRAM_APP_CALLBACK_OAUTHCALLBACK;
    ...
    public InstagramOAuthDialog(Context context, String url, GenericDialogListener listener) {
        super(context);
        mUrl = url;
        mListener = listener;
    }
    ...
    private void setUpTitle() {
        ...
        mTitle.setText("INSTAGRAM OAuth");
    ...
    private void setUpWebView() {
        ...
        mWebView.setWebViewClient(new InstagramOAuthDialog.OAuthWebViewClient());
