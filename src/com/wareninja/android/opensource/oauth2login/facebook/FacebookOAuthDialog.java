...
public class FacebookOAuthDialog extends Dialog {
    ...
    public FacebookOAuthDialog(Context context, String url, GenericDialogListener listener) {
        super(context);
        mUrl = url;
        mListener = listener;
    }
    ...
    private void setUpWebView() {
        ...
        mWebView.setWebViewClient(new FacebookOAuthDialog.OAuthWebViewClient());
    ...
    private class OAuthWebViewClient extends WebViewClient {
        ...
        public void onReceivedError(WebView view, int errorCode,
            ...
            FacebookOAuthDialog.this.dismiss();
        }
